package com.daoyiksw.browsesocial.views;
...
public class EasyNavigationBars extends LinearLayout {
    ...
    public void setNavigationLayout(LinearLayout navigationLayout) {
...
//    private Techniques anim = null;
    ...
    private EasyNavigationBars.OnTabClickListener onTabClickListener;
    ...
    public EasyNavigationBars(Context context) {
        super(context);

        initViews(context, null);
    }

    public EasyNavigationBars(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//要放在前面
    ...
    public EasyNavigationBars setupWithViewPager(@NonNull ViewPager viewPager) {
...
//        }
    ...
    public EasyNavigationBars setupWithViewPager(@NonNull ViewPager2 viewPager2) {
//        final PagerAdapter adapter = viewPager.getAdapter();
//        if (adapter == null) {
//            throw new IllegalArgumentException("ViewPager does not have a PagerAdapter set");
//        }
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
     ...
     * 重置各个参数
     */
    public EasyNavigationBars defaultSetting() {
...
//        anim = null;
    ...
    public EasyNavigationBars centerImageRes(int centerImageRes) {
    ...
    public EasyNavigationBars centerTextStr(String centerTextStr) {
...
//                    YoYo.with(anim).duration(300).playOn(tabList.get(i));
    ...
    public EasyNavigationBars centerLayoutHeight(int centerLayoutHeight) {
        this.centerLayoutHeight = NavigationUtil.dip2px(getContext(), centerLayoutHeight);
        return this;
    }

    public EasyNavigationBars scaleType(ImageView.ScaleType scaleType) {
        this.scaleType = scaleType;
        return this;
    }


    public EasyNavigationBars mode(int mode) {
        this.mode = mode;
        return this;
    }

    public EasyNavigationBars hasPadding(boolean hasPadding) {
        this.hasPadding = hasPadding;
        return this;
    }

    public EasyNavigationBars centerIconSize(float centerIconSize) {
        this.centerIconSize = NavigationUtil.dip2px(getContext(), centerIconSize);
        return this;
    }


    public EasyNavigationBars navigationBackground(int navigationBackground) {
        this.navigationBackground = navigationBackground;
        return this;
    }

    public EasyNavigationBars navigationHeight(int navigationHeight) {
        this.navigationHeight = NavigationUtil.dip2px(getContext(), navigationHeight);
        return this;
    }

    public EasyNavigationBars normalTextColor(int normalTextColor) {
        this.normalTextColor = normalTextColor;
        return this;
    }

    public EasyNavigationBars selectTextColor(int selectTextColor) {
        this.selectTextColor = selectTextColor;
        return this;
    }

    public EasyNavigationBars lineHeight(int lineHeight) {
        this.lineHeight = lineHeight;
        return this;
    }

    public EasyNavigationBars lineColor(int lineColor) {
        this.lineColor = lineColor;
        return this;
    }

    public EasyNavigationBars tabTextSize(int tabTextSize) {
        this.tabTextSize = tabTextSize;
        return this;
    }

    public EasyNavigationBars tabTextTop(int tabTextTop) {
        this.tabTextTop = NavigationUtil.dip2px(getContext(), tabTextTop);
        return this;
    }

    public EasyNavigationBars msgPointTextSize(int msgPointTextSize) {
        this.msgPointTextSize = msgPointTextSize;
        return this;
    }

    public EasyNavigationBars msgPointSize(float msgPointSize) {
        this.msgPointSize = NavigationUtil.dip2px(getContext(), msgPointSize);
        return this;
    }

    public EasyNavigationBars msgPointLeft(int msgPointLeft) {
        this.msgPointLeft = NavigationUtil.dip2px(getContext(), msgPointLeft);
        return this;
    }

    public EasyNavigationBars msgPointTop(int msgPointTop) {
        this.msgPointTop = NavigationUtil.dip2px(getContext(), msgPointTop);
        return this;
    }


    public EasyNavigationBars hintPointSize(float hintPointSize) {
        this.hintPointSize = NavigationUtil.dip2px(getContext(), hintPointSize);
        return this;
    }

    public EasyNavigationBars hintPointLeft(int hintPointLeft) {
        this.hintPointLeft = NavigationUtil.dip2px(getContext(), hintPointLeft);
        return this;
    }

    public EasyNavigationBars hintPointTop(int hintPointTop) {
        this.hintPointTop = NavigationUtil.dip2px(getContext(), hintPointTop);
        return this;
    }


    public EasyNavigationBars titleItems(String[] titleItems) {
        this.titleItems = titleItems;
        return this;
    }

    public EasyNavigationBars normalIconItems(int[] normalIconItems) {
        this.normalIconItems = normalIconItems;
        return this;
    }

    public EasyNavigationBars selectIconItems(int[] selectIconItems) {
        this.selectIconItems = selectIconItems;
        return this;
    }

    public EasyNavigationBars fragmentList(List<Fragment> fragmentList) {
        this.fragmentList = fragmentList;
        return this;
    }

    public EasyNavigationBars fragmentManager(FragmentManager fragmentManager) {
        this.fragmentManager = fragmentManager;
        return this;
    }

//    public EasyNavigationBars anim(Anim anim) {
//        if (anim != null) {
...
//    }
    ...
    public EasyNavigationBars centerLayoutRule(int centerLayoutRule) {
        this.centerLayoutRule = centerLayoutRule;
        return this;
    }

    public EasyNavigationBars canScroll(boolean canScroll) {
        this.canScroll = canScroll;
        return this;
    }

    public EasyNavigationBars smoothScroll(boolean smoothScroll) {
        this.smoothScroll = smoothScroll;
        return this;
    }


    public EasyNavigationBars setOnTabClickListener(EasyNavigationBars.OnTabClickListener onTabClickListener) {
        this.onTabClickListener = onTabClickListener;
        return this;
    }

    public EasyNavigationBars setOnCenterTabClickListener(OnCenterTabSelectListener onCenterTabClickListener) {
        this.onCenterTabClickListener = onCenterTabClickListener;
        return this;
    }

    public EasyNavigationBars iconSize(float iconSize) {
        this.iconSize = NavigationUtil.dip2px(getContext(), iconSize);
        return this;
    }

    public EasyNavigationBars centerLayoutBottomMargin(int centerLayoutBottomMargin) {
        this.centerLayoutBottomMargin = NavigationUtil.dip2px(getContext(), centerLayoutBottomMargin);
        return this;
    }

    public EasyNavigationBars centerAsFragment(boolean centerAsFragment) {
        this.centerAsFragment = centerAsFragment;
        return this;
    }

    public EasyNavigationBars addCustomView(View customAddView) {
        this.customAddView = customAddView;
        return this;
    }

    public EasyNavigationBars centerTextSize(int centerTextSize) {
        this.centerTextSize = NavigationUtil.dip2px(getContext(), centerTextSize);
        return this;
    }

    public EasyNavigationBars centerNormalTextColor(int centerNormalTextColor) {
        this.centerNormalTextColor = centerNormalTextColor;
        return this;
    }

    public EasyNavigationBars centerSelectTextColor(int centerSelectTextColor) {
        this.centerSelectTextColor = centerSelectTextColor;
        return this;
    }

    public EasyNavigationBars centerTextTopMargin(int centerTextTopMargin) {
        this.centerTextTopMargin = NavigationUtil.dip2px(getContext(), centerTextTopMargin);
        return this;
    }

    public EasyNavigationBars centerAlignBottom(boolean centerAlignBottom) {
...
//    }
    ...
    public EasyNavigationBars.OnTabClickListener getOnTabClickListener() {
    ...
    public EasyNavigationBars textSizeType(int textSizeType) {
    ...
    public EasyNavigationBars setMsgPointMoreWidth(float msgPointMoreWidth) {
    ...
    public EasyNavigationBars setMsgPointMoreHeight(float msgPointMoreHeight) {
    ...
    public EasyNavigationBars setMsgPointMoreRadius(int msgPointMoreRadius) {
    ...
    public EasyNavigationBars setMsgPointColor(int msgPointColor) {
        this.msgPointColor = msgPointColor;
        return this;
    }

    public EasyNavigationBars setOnTabLoadListener(OnTabLoadListener onTabLoadListener) {
